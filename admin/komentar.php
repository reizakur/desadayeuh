...
while ($row= mysqli_fetch_array($sql)){
  ...
  echo"<tr>";?>
                        ...
                        <td><?php echo $row['komentar'] ?></td> <td>        <a href='eksekusi_hapus_komentar.php?id_komentar=<?php echo $row['id_komentar']?>' class='btn btn-danger'><span class='fa fa-trash fa-1x'> |
                                               <?php }?> 
                                                  </a></td>
                                        </td>
                                        </tr>
