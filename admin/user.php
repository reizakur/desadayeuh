...
if(isset($_POST['qcari'])){
  $qcari = $_POST['qcari'];
$sql=mysqli_query($con,"SELECT * FROM user where idlike 
...
while ($row= mysqli_fetch_array($sql)){
  ...
  echo"<tr>";?>
                        ...
                        <td><?php echo $row['gmail'] ?></td> <td>        <a href='eksekusi_hapus_user.php?id=<?php echo $row['id']?>' class='btn btn-danger'><span class='fa fa-trash fa-1x'> |
                                               <?php }?> 
                                                  </a></td>
                                        </td>
                                        </tr>
